...
public class AssignmentServiceHttp {
	...
	public static long getAssignmentsByKeywordsCountByKeywords(
		HttpPrincipal httpPrincipal, long groupId, String keywords) {

		try {
			MethodKey methodKey = new MethodKey(
				AssignmentServiceUtil.class,
				"getAssignmentsByKeywordsCountByKeywords",
				_getAssignmentsByKeywordsCountByKeywordsParameterTypes5);
	...
	private static final Class<?>[]
		_getAssignmentsByKeywordsCountByKeywordsParameterTypes5 = new Class[] {
